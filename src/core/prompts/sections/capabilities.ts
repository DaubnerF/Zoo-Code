 ...
 * @param policy Optional effective tool policy. When provided, prose tied to
 *   `execute_command` and `ask_followup_question` is emitted only if those tools
 *   are in the policy's tool set.
 */
